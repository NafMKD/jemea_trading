  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute top-0 right-0 w-[60%] h-full bg-gradient-to-bl from-gold-500/10 via-gold-600/5 to-transparent"
          style={{
        ...
        <motion.div
          style={{ y: heroY }}
          className="absolute top-20 right-[15%] w-32 h-32 border border-gold-500/20 rotate-45 hidden lg:block"
        />
        <motion.div
          style={{ y: heroY }}
          className="absolute bottom-32 right-[25%] w-20 h-20 border border-gold-500/15 rotate-12 hidden lg:block"
        />
        <motion.div
          style={{ y: heroY }}
          className="absolute top-[40%] left-[8%] w-16 h-16 bg-gold-500/5 rotate-45 hidden lg:block"
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-32">
            ...
            <div>
              ...
              >
                ...
                <span className="font-body text-xs uppercase tracking-[0.3em] text-gold-400 font-semibold">
              ...
              <motion.p
                ...
                className="mt-6 font-body text-base text-coffee-300 max-w-lg leading-relaxed"
              >
              ...
              >
                ...
                <Link href="/about">
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-coffee-400 text-coffee-200 hover:bg-coffee-800 hover:text-white hover:border-coffee-600"
                  >
                    Our Story
                  </Button>
                </Link>
              ...
              <motion.div
                ...
                className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-6 border-t border-coffee-800 pt-8"
              >
                {stats.map((stat, i) => (
                  <motion.div
                    key={stat.label}
                  ...
                  >
                    <div className="font-heading text-2xl font-bold text-gold-400">
                      {stat.value}
                    </div>
                    <div className="font-body text-[11px] uppercase tracking-wider text-coffee-400 mt-1">
                      {stat.label}
                    </div>
                  </motion.div>
                ))}
            ...
            {/* Right side - Product imagery composition */}
            <motion.div
            ...
            >
              <div className="relative w-full max-w-lg">
                ...
                <div className="relative aspect-square">
                  <div className="absolute inset-8 border-2 border-gold-500/30 rotate-45" />
                  <div className="absolute inset-16 border border-gold-500/15 rotate-45" />
        ...
        >
          ...
          >
            <span className="text-coffee-400 text-[10px] uppercase tracking-[0.2em] font-body">
              Scroll
            </span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {highlights.map((item, i) => (
              <Reveal key={item.title} delay={i * 0.1}>
                ...
                >
                  {/* Top left accent */}
                  <div className="absolute top-0 left-0 w-10 h-[2px] bg-[var(--accent)] transition-all duration-500 group-hover:w-full" />
                  <div className="absolute top-0 left-0 h-10 w-[2px] bg-[var(--accent)] transition-all duration-500 group-hover:h-full" />

                  <item.icon className="w-7 h-7 text-[var(--accent)] mb-4" strokeWidth={1.5} />
      ...
      <section className="relative py-28 md:py-36">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <SectionHeading
            label="Our Products"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <Reveal direction="left">
              <div className="relative p-4">
                ...
                {/* Offset accent frame */}
                <div className="absolute bottom-0 right-0 w-full h-full border-2 border-[var(--accent)] -z-10" />
              </div>
            </Reveal>
            ...
            <div>
              ...
              <Reveal direction="right" delay={0.1}>
                <h2 className="font-heading text-3xl md:text-4xl font-bold leading-[1.15] text-[var(--foreground)] mb-5">
                  ...
                  <span className="text-[var(--accent)]">to the World</span>
                </h2>
              </Reveal>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="absolute top-10 left-10 w-40 h-40 border border-gold-500/10 rotate-45 hidden lg:block" />
        <div className="absolute bottom-10 right-10 w-60 h-60 border border-gold-500/10 rotate-12 hidden lg:block" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Reveal delay={0.1}>
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.1]">
              Ready to Source{" "}
              <span className="text-gold-400">Premium Ethiopian</span> Products?
            </h2>
          </Reveal>

          <Reveal delay={0.2}>
            <p className="mt-5 font-body text-base text-coffee-300 max-w-2xl mx-auto leading-relaxed">
